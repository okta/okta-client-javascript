[@okta/auth-foundation](../..) / [Core](../index.md) / CredentialError

# Class: CredentialError

Thrown when a [Credential](https://developer.mozilla.org/docs/Web/API/Credential) instance encounters an unexpected condition
...
> **new CredentialError**(`message?`, `options?`): `CredentialError`
