[@okta/auth-foundation](../..) / [Core](../index.md) / TokenOrchestratorError

# Class: TokenOrchestratorError

Thrown when a [TokenOrchestrator](../../TokenOrchestrator/index.md) encounters an unexpected condition
...
> **new TokenOrchestratorError**(`message?`, `options?`): `TokenOrchestratorError`
