...
and [SubApps](../classes/SubAppOrchestrator.md). The [Host](classes/HostOrchestrator.md) brokers tokens
on behalf of [SubApps](../classes/SubAppOrchestrator.md). [SubApps](../classes/SubAppOrchestrator.md)
...
| Name | Description |
| ------ | ------ |
| [Host](classes/HostOrchestrator.md) | Receives and fulfills delegated [Token](/api/auth-foundation/Token/) requests from [SubApp](../classes/SubAppOrchestrator.md) instances |
...
| Name | Description |
| ------ | ------ |
| [SubApp](../classes/SubAppOrchestrator.md) | An implementation of [TokenOrchestrator](/api/auth-foundation/TokenOrchestrator/) which delegates all token retrieval to a centralized broker, rather than acquiring tokens itself |
| [SubAppOptions](type-aliases/SubAppOptions.md) | Options to change configurable behavior of [SubApp](../classes/SubAppOrchestrator.md) |
